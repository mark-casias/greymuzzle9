...
abstract class ArgumentPluginBase extends HandlerBase implements CacheableDependencyInterface {
  ...
  protected function defineOptions() {
    ...
    $options['breadcrumb_enable'] = ['default' => FALSE];
    $options['breadcrumb'] = ['default' => ''];
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['breadcrumb_enable'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Override breadcrumb'),
      '#default_value' => $this->options['breadcrumb_enable'],
      '#fieldset' => 'argument_present',
    ];
    $form['breadcrumb'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Provide breadcrumb'),
      '#title_display' => 'invisible',
      '#default_value' => $this->options['breadcrumb'],
      '#description' => $this->t('Enter a breadcrumb name you would like to use. You may use Twig syntax in this field.'),
      '#states' => [
        'visible' => [
          ':input[name="options[breadcrumb_enable]"]' => ['checked' => TRUE],
        ],
      ],
      '#fieldset' => 'argument_present',
    ];
  ...
  public function submitOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    if (empty($option_values['breadcrumb_enable'])) {
      $option_values['breadcrumb'] = '';
    }
  }
